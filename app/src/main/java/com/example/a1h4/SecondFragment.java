    ...
    private void setClick() {
        adapter.setListiner(model1 -> {
            ...
            private void createList() {
                list = new ArrayList<>();
                list.add(new User("1", "Venom", "Gostmne", "3:00"));
                list.add(new User("2", "Merry", "Ghostane", "3:00"));
                ...
                list.add(new User("7", "Стельный круг", "FAE", "3:00"));
                list.add(new User("8", "Калашников", "FACE", "3:00"));
                list.add(new User("9", "Юмор", "FAE", "3:00"));
                list.add(new User("10", "Рэман", "FACE", "3:00"));
